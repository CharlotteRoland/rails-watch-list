...
liste_1 = List.create(name: "liste 1")
Bookmark.create(list: liste_1, comment: "blabla", movie: movie_1)
Bookmark.create(list: liste_1, comment: "bloblo", movie: movie_2)

liste_2 = List.create(name: "liste 2")
Bookmark.create(list: liste_2, comment: "youhou", movie: movie_3)
Bookmark.create(list: liste_2, comment: "aaaaaaaa", movie: movie_4)
